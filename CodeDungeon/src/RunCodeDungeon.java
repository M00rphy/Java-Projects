...
public class RunCodeDungeon {
			...
			playerClass = Integer
					.parseInt(JOptionPane
							.showInputDialog("Pick a Class: \n"
									+ "<1> Cracker (AKA The Ilegal): Good with viruses and pretty fine with code but firewalls kill him. Low intelligence... \n"
									+ "<2> CEO (AKA The Slaver): Very intelligent and lots and lots of system space but can't code. \n"
									+ "<3> Coder : Great with code, kinda bad system space, decent viruses and firewalls. \n"
                                                                        + "<4> Hacker (AKA The Smartass) : Pretty good with code, decent system space, good with viruses and firewalls, good social engineering skills. \n"));
		} catch (NumberFormatException e) {
		...
		case 3:
			...
			break;
                ...
                case 4:
                        ...
                        viruses = generator.nextInt(1) + 3;
                        code = generator.nextInt(1) + 3;
                        system = generator.nextInt(20) + 25;
                        intelligence = generator.nextInt(2) + 3;
                        break;
		default:
	...
	public static void merchant() {
		try {
			buy = Integer
					.parseInt(JOptionPane
							.showInputDialog("Shady Merchant: What are yousa buyen?"
									+ "\n <1> USB - 10 BitCoins"
									+ "\n <2> Tech Support - 20 BitCoins"
									+ "\n <3> Trojan Virus - 30 BitCoins"
									+ "\n <4> Anti-Virus - 15 BitCoins"
									+ "\n \n BitCoins: " + cash
									+ "\n <5> I'm just watching thanks :)!"));
		} catch (NumberFormatException e) {
			say("Yousa input a invalid option!.");
			merchant();
		}
		...
		case 1:
			if(cash >= 10) {
				...
				say("Yousa do not have enough money for that. Are yousa trying to scam the scammer???");
			}
			break;
		case 2:
			if(cash >= 30) {
	...
	public static void main(String[] args) {
		...
		JOptionPane
				.showMessageDialog(
						null,
						"You are traveling on a long journey away from your home in the land of Javascript. In the distance you see a traveler. \n \n Villager: Greetings young "
								+ classString
		...
		if (accept == 0) {
			...
			say("Villager: Oh... That's okay... \n \n The whole village of Macintosh was later slaughtered...");
		}
	}
